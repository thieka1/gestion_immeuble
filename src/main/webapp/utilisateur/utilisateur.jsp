...
<div class="main-content">
    <div class="page-header">
        ...
        <p class="page-subtitle">Gérez tous les utilisateurs de la plateforme</p>
    </div>

    <div class="content-card">
        <div class="card-header">
            <h2 class="card-title">Liste des utilisateurs</h2>
            <a href="?action=add" class="btn-primary">Nouvel utilisateur</a>
        </div>
                    ...
                    <c:when test="${not empty utilisateurs}">
                        <c:forEach items="${utilisateurs}" var="u">
                            <tr>
                                ...
                                <td>
                                    <div style="font-weight: 600; font-size: 16px;">${u.nom} ${u.prenom}</div>
                                </td>
                                <td>
                                    <div class="contact-info">
                                        <span class="email">${u.email}</span>
                                        <span class="phone">📞 ${u.telephone}</span>
                                    </div>
                                </td>
                                <td>
                                    <c:choose>
                                        ...
                                        <c:when test="${u.role eq 'PROPRIETAIRE'}">
                                            <span class="role-badge role-proprietaire">🏠 Propriétaire</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span class="role-badge role-locataire">🏡 Locataire</span>
                                        </c:otherwise>
                                    </c:choose>
                                </td>
                                <td class="actions-cell">
                                    <a href="?action=edit&id=${u.id}" class="btn-action btn-edit">
                                        ✏️ Modifier
                                    </a>
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="empty-state">
                                    ...
                                    <p style="margin-top: 10px; font-size: 14px;">Commencez par créer votre premier utilisateur</p>
                                </div>
                            </td>
                        </tr>
                    </c:otherwise>
