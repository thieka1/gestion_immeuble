...
<div class="sidebar">
    <div class="sidebar-header">
        <a href="${pageContext.request.contextPath}/dashboard/proprietaire" class="logo">
    ...
    <div class="user-info">
        ...
        <div class="user-name">Propriétaire</div>
        <div class="user-role">Gestion Patrimoine</div>
    </div>
    ...
    <nav class="sidebar-nav">
        <div class="nav-section">
            ...
            <a href="${pageContext.request.contextPath}/dashboard/proprietaire" class="nav-item">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Optionnel: Charger les statistiques via AJAX
        // loadQuickStats();
    });

    /*
    function loadQuickStats() {
        // Exemple de fonction pour charger les statistiques
        fetch('${pageContext.request.contextPath}/api/proprietaire/stats')
            .then(response => response.json())
            .then(data => {
                document.querySelector('.stat-item:nth-child(2) .stat-value').textContent = data.immeubles || '0';
                document.querySelector('.stat-item:nth-child(3) .stat-value').textContent = data.unites || '0';
                document.querySelector('.stat-item:nth-child(4) .stat-value').textContent = data.locataires || '0';
            })
