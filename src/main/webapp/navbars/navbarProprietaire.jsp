...
<style>
    ...
    .navbar .logout:hover { background-color: #c0392b; }

    /* Responsive */
    @media screen and (max-width: 600px) {
        .navbar a { float: none; width: 100%; }
        .navbar .logout { width: 100%; text-align: center; float: none; margin: 5px 0; }
    }
</style>

<div class="navbar">
    <!-- Logo / accueil du dashboard propriétaire -->
    <a href="${pageContext.request.contextPath}/dashboard/proprietaire" class="logo">Propriétaire dashboard</a>
