...
<div class="main-content">
    ...
    <div class="form-container">
        ...
        <form action="unite?action=save" method="post" enctype="multipart/form-data" id="uniteForm">
            ...
            <div class="form-group">
                <label for="statut">Statut <span class="text-danger">*</span></label><br>
                <input type="radio" id="statut_dispo" name="statut" value="DISPONIBLE" checked>
                <label for="statut_dispo">Disponible</label>

                <input type="radio" id="statut_loue" name="statut" value="LOUE">
                <label for="statut_loue">Louée</label>
            </div>
